...
**Takeaway:** With small attention ops (simulated), stream synchronization overhead dominates — overlap doesn't help. With real attention on long sequences (4K+), overlap would show positive gains. The infrastructure supports it; the workload needs to be large enough.j
